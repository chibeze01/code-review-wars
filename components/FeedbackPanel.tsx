...
export function FeedbackPanel({ result, generated, comments, generalNotes, honorEarned, rankUp, onNext, onReset }: Props) {
  ...
  return (
    <div className="flex flex-col gap-5">
      {rankUp && (
        <div
          className="rounded-xl border-2 px-5 py-4 flex items-center gap-4 bg-[#1c2128]"
      ...
      <div className="bg-[#1c2128] border border-[#30363d] rounded-xl p-5 flex items-center gap-5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-mono font-semibold text-slate-200 flex items-center gap-2">
              {typeof honorEarned === 'number' && honorEarned > 0 && (
                <span className="text-xs font-sans font-bold text-yellow-500 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-2 py-0.5">
                  +{honorEarned} honor
                </span>
              )}
              {result.score}/100
