...
export function CodeReviewSession({ generated, onSubmit, loading }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      {/* Annotated code editor — GitHub-style inline comments */}
      <AnnotatedCodeEditor
        code={generated.code}
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          placeholder="e.g. 'Overall the error handling is weak, the auth layer has several gaps, and the DB queries will not scale…'"
          rows={4}
